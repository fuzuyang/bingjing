# -*- coding: utf-8 -*-
"""
Created on Thu Nov 13 07:57:37 2025
...
#读取excel数据
df = pd.read_excel(r"C:\Users\29944\Desktop\137反电信网络诈骗法法条正文.xlsx", 
                 sheet_name="法条正文", 
                 dtype={1: int, 2: int})  # 1和2表示列的索引位置（从0开始）
df = df.fillna("")
...
insert_sql=f"INSERT INTO 1_2Provision_content({columns}) VALUES ({placeholders})"      #表名在此
